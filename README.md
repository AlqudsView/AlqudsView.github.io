...
<html lang="en">
    ...
    <meta name="description" content="Talat Al-Quds Restaurant and Café offers you a luxurious tasting menu of multiple varieties of fine foods and juices, as well as varieties of unparalleled desserts.">
    <meta property="og:title" content="Talet Al Qodus"/>
    <meta property="og:url" content="https://amenomenu.com/talet-al-qodus"/>
    <meta property="og:description" content="Talat Al-Quds Restaurant and Café offers you a luxurious tasting menu of multiple varieties of fine foods and juices, as well as varieties of unparalleled desserts."/>
...
<!--<link rel="alternate" hreflang="ar" href="https://amenomenu.com">-->
<!--<link rel="alternate" hreflang="en" href="https://en.amenomenu.com">-->

<!--<script type="text/javascript" src="https://cdn.weglot.com/weglot.min.js"></script>-->
<!--<script>-->
<!--    Weglot.initialize({-->
<!--        api_key: 'wg_724002823fa738e73b753ec5bf18cacc4'-->
<!--    });-->
<!--</script>-->
...
<body>
    ...
    <div class="button-container">
        <!-- Button with a link -->
        <a href="https://alqudsview.github.io/Alqudsview2/" class="my-button">العربية</a>
    </div>
                                ...
                                <div id="content125" class="menu-category-content collapse">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Egg with Cheese pottery</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Eggs with Sausage pottery</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Eggs with Tommatoo pottery</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Hummous plate</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Hummus Beiruti</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Hummus with meat and nuts</h6>
                                                        <span class="text-muted text-sm">Meat net weight (200Gram)</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Eggplant savoury</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Baba ghanoush</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.25 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Turkey plate small</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>1.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Butter with Jam (Strawberry/apricot)</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Yellow Cheese</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>1.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Makdous eggplant (Pickled stuffed eggplant in olive oil)</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>1.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Olives plate (Black/Green)</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Tomato frying pan with meat and nuts</h6>
                                                        <span class="text-muted text-sm">Meat net weight (250Gram)</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Potato mofarakeh</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Sausage with vegetables</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Hummus fatteh</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Fried kebbeh (4 pieces) </h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Potato and cheese plate</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Sambousek (4 pieces)</h6>
                                                        <span class="text-muted text-sm">(Cheese)</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Service plate</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>1.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Mozzarella stick (5 pieces)</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                ...
                                <div id="content126" class="menu-category-content collapse">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">The Bounties of my Country abacus</h6>
                                                        <span class="text-muted text-sm">( Breakfast Offer Only)</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                ...
                                <div id="content127" class="menu-category-content collapse">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Mix Half kilo </h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Meat shokaf 1 kilo</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Meat shokaf Half kilo</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Kebab Half kilo</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Grilled Chicken 1 kilo</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Grilled Chicken Half kilo</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                ...
                                <div class="menu-category-title collapse-toggle" role="tab" data-target="#content128" data-toggle="collapse" aria-expanded="false">
                                    <div class="bg-image">
                                        <img src="https://amenomenu.com/images/products_categories_images/1765144358902257.jpg" alt="">
                                                                            ...
                                                                            <h2 class="title">Alquds View Dishes</h2>
                                                                    </div>
                                <div id="content128" class="menu-category-content collapse">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Meat sajia (1/2)</h6>
                                                        <span class="text-muted text-sm">JD 18.00 Per kilo</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>9.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Chicken pottery</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>6.75 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Fish Sajia</h6>
                                                        <span class="text-muted text-sm">JD 12.00 Per kilo</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">chicken with cream pottery</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>7.50 JOD</span></span>
                                ...
                                <div class="menu-category-title collapse-toggle" role="tab" data-target="#content129" data-toggle="collapse" aria-expanded="false">
                                    <div class="bg-image">
                                        <img src="https://amenomenu.com/images/products_categories_images/1765144392925714.png" alt="">
                                                                            ...
                                                                            <h2 class="title">Pottery's and trays</h2>
                                                                    </div>
                                <div id="content129" class="menu-category-content collapse">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Kofta tray with tomatoes 500gram</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>6.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Kofta tray with tahini 500Gram</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>6.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Meat pottery with vegetables</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Zinger pottery</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                ...
                                <div id="content130" class="menu-category-content collapse">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Fusilli white sauce</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Spaghetti Bolognese</h6>
                                                        <span class="text-muted text-sm">(Meat&amp;Tomato sauce)</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Fettuccine</h6>
                                                        <span class="text-muted text-sm">JD 3.90  Fettuccine with Chicken</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Lasagna with meat</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Penna Arabiata (Rosy Sauce)</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.60 JOD</span></span>
                                ...
                                <div class="menu-category-title collapse-toggle" role="tab" data-target="#content131" data-toggle="collapse" aria-expanded="false">
                                    <div class="bg-image">
                                        <img src="https://amenomenu.com/images/products_categories_images/1765144692757962.webp" alt="">
                                                                            ...
                                                                            <h2 class="title">Salads and appetizers</h2>
                                                                    </div>
                                <div id="content131" class="menu-category-content collapse">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Alquds view salad</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>6.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Pineapple tabbouleh</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Caesar salad with Chicken</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Cucumber with yoghurt</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Turkish Salad</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Mix appetizer plate</h6>
                                                        <span class="text-muted text-sm">(muhammara ،Spicy labneh with walnuts ، turkish salad ، Beetroot stew )</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.75 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Arugula salad</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Fattoush salad</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Coleslaw salad</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Mutabbal eggplant</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Baba Ghanoush (Small)</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.25 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Beetroot stew</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Spicy labneh with walnuts</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.00 JOD</span></span>
                                ...
                                <div class="menu-category-title collapse-toggle" role="tab" data-target="#content132" data-toggle="collapse" aria-expanded="false">
                                    <div class="bg-image">
                                        <img src="https://amenomenu.com/images/products_categories_images/1765146069070623.jpeg" alt="">
                                                                            ...
                                                                            <h2 class="title">Hot appetizers</h2>
                                                                    </div>
                                <div id="content132" class="menu-category-content collapse">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Fried kibbeh 4 pieces</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.15 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Tomato fryer with meat and nuts</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>5.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">French Fries with cheese</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.00 JOD</span></span>
                                ...
                                <div class="menu-category-title collapse-toggle" role="tab" data-target="#content221" data-toggle="collapse" aria-expanded="false">
                                    <div class="bg-image">
                                        <img src="https://amenomenu.com/images/products_categories_images/1766165532367281.jpeg" alt="">
                                                                            ...
                                                                            <h2 class="title">Today's drink</h2>
                                                                    </div>
                                <div id="content221" class="menu-category-content collapse">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">The View date's drink</h6>
                                                        <span class="text-muted text-sm">With a pinch of cinnamon, take it and pray for me</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.00 JOD</span></span>
                                ...
                                <div id="content133" class="menu-category-content collapse">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Single Turkish coffee</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>1.25 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Double Turkish coffee</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Espresso shot</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>1.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Double shot espresso</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Americano coffee</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">cappuccino</h6>
                                                        <span class="text-muted text-sm">(Choose a flavor)(skim milk available)</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Caramel macchiato</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">French Coffee</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.95 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Spanish Latte</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Alquds view Hot chocolate</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Alquds View coffee</h6>
                                                        <span class="text-muted text-sm">(Special ingredients)</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.95 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Tropical coffee</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">The view panadol</h6>
                                                        <span class="text-muted text-sm">( The healer is God, but we are trying )</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">aromatic herb</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>1.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">sahlab</h6>
                                                        <span class="text-muted text-sm">(If it's not tasty, take it back)</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                ...
                                <div id="content134" class="menu-category-content collapse">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Alquds view frappe</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Caramel frappe</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Vanilla Frappe</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Ice Latte</h6>
                                                        <span class="text-muted text-sm">( Choose a Flavor )</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Ice white Mocha</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Ice caramel macchiato</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Ice Tea</h6>
                                                        <span class="text-muted text-sm">Peach / lemon / passion fruit</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Classic mojito</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">strawberry mojito</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">passion fruit mojito</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">RaseBerry mojito</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Blue Ocean Mix</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Soda</h6>
                                                        <span class="text-muted text-sm">( Pepsi / mirinda / Seven up )</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>1.00 JOD</span></span>
                                ...
                                <div id="content135" class="menu-category-content collapse">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Kiwi and StrawBerry</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">StrawBerry and Manjo</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.99 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Kiwi and Lemmon</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                ...
                                <div class="menu-category-title collapse-toggle" role="tab" data-target="#content136" data-toggle="collapse" aria-expanded="false">
                                    <div class="bg-image">
                                        <img src="https://amenomenu.com/images/products_categories_images/1765146461085686.jpg" alt="">
                                                                            ...
                                                                            <h2 class="title">smoothies &amp; Mocktail</h2>
                                                                    </div>
                                <div id="content136" class="menu-category-content collapse">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Bananna and milk</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Lemmon Smoothie</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Lemmon and Mint smoothie</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Manjo Smoothie</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Strawberry Smoothie </h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Mango with basil</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Roca Lemonade</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Strawberry Sour</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">The view Panadol</h6>
                                                        <span class="text-muted text-sm">( God is the healer, but we are trying )</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Coco Lavender</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">passion fruit Creamy</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.25 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Summer Delight</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Alquds view Delight</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.00 JOD</span></span>
                                ...
                                <div class="menu-category-title collapse-toggle" role="tab" data-target="#content137" data-toggle="collapse" aria-expanded="false">
                                    <div class="bg-image">
                                        <img src="https://amenomenu.com/images/products_categories_images/1765146513954500.png" alt="">
                                                                            ...
                                                                            <h2 class="title">Milkshake's</h2>
                                                                    </div>
                                <div id="content137" class="menu-category-content collapse">
                                                                                                                        <!-- Menu Item -->
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Alquds view Milkshake</h6>
                                                        <span class="text-muted text-sm">Red velvet</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Normal Milkshakes</h6>
                                                        <span class="text-muted text-sm">(Vanilla / Chocolate / Strawberry)</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.75 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Special milkshakes</h6>
                                                        <span class="text-muted text-sm">(Oreo / Snickers / Lotus / Crocan / Arabic / Cheesecake)</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.00 JOD</span></span>
                                ...
                                <div id="content138" class="menu-category-content collapse">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Special ice cream</h6>
                                                        <span class="text-muted text-sm">(Oreo / Snickers / Lotus / Crocan / Arabic / Cheesecake)</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>2.25 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Icecream</h6>
                                                        <span class="text-muted text-sm">(Vanilla / Chocolate / Strawberry)</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>1.99 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Threw Chocolate</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.00 JOD</span></span>
                                ...
                                <div id="content139" class="menu-category-content collapse">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Two apples (Nakhla)</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>4.50 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Two apples (mazaya)</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>4.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Lemon and mint</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>4.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Watermelon and mint</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>4.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Grapes and berries</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>4.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Gum and cinnamon</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>4.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Grapes and Mint </h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>4.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">spearment Gum</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>4.00 JOD</span></span>
                                ...
                                <div id="content140" class="menu-category-content collapse">
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Um Ali pottery - Egyptian Dessert (5 persons)</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>6.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Um Ali pottery - Egyptian Dessert (2 persons)</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Burger cake</h6>
                                                        <span class="text-muted text-sm">Something Very Delicious </span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Special cheesecake</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Brownies</h6>
                                                        <span class="text-muted text-sm">With a scoop of vanilla ice cream</span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>3.00 JOD</span></span>
                                            ...
                                            <div class="menu-item menu-list-item text-right" dir=rtl>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-6 mb-2 mb-sm-0 text-right">
                                                        <h6 class="mb-0">Medium cake mold for 10 people</h6>
                                                        <span class="text-muted text-sm"></span>
                                                    </div>
                                                                                                        <div class="col-sm-6 text-sm-left">
                                                        <span class="text-md ml-4 font-weight-bold"> <span data-product-base-price>10.00 JOD</span></span>
    ...
    <div class="container">
        ...
        <div class="footer-first-row row" style="background: white;">
            ...
            <div class="col-lg-12 col-md-12 text-center">
                <h5 class="mb-3" style="color: #383c40;"></h5>
            </div>
            ...
            <div class="col-lg-12 col-md-12 text-center">
                ...
                <h5 class="mb-3" style="color: #383c40;">Social Media</h5>
                        ...
                        <i class="fa fa-phone"></i>
                                                    ...
                                                    <a href="https://www.facebook.com/AlqudsViewRestaurant" class="icon icon-social icon-circle icon-sm icon-facebook ">
                        <i class="fa fa-facebook"></i>
                    </a>
                                                    <a href="https://www.instagram.com/view_alquds/" class="icon icon-social icon-circle icon-sm icon-instagram ">
                        <i class="fa fa-instagram"></i>
                    </a>
                                                    <a href="https://wa.me/7 9113 7444" class="icon icon-social icon-circle icon-sm icon-whatsapp ">
                        <i class="fa fa-whatsapp"></i>
                    </a>
                                                                                                                    <a href="https://goo.gl/maps/af4o9jabfdioLGmN8" class="icon icon-social icon-circle icon-sm icon-google ">
    ...
    <div class="bg-dark">
        ...
        <div class="footer-second-row text-center">
            <span class="text-muted"><a href="https://amenomenu.com/user"><strong>GO TO MY ACCOUNT</strong></a></span><br><br>
            <span class="text-muted">Ameno Menu &#xA9; 2023. All Right Reserved <br> Developed by Ameno Group Web Solutions</span>
            <div>
                <a href="#">
                    <img src="https://amenomenu.com/images/logo-muted.png" alt=""
                    width="50" class="mt-2 mb-2">
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="text-center">
        <a href="#">
            <img src="https://amenomenu.com/images/qr_code/30.png" alt="" width="200">
        </a>
    </div>
    <div class="text-center mt-4">
        <h5><a class="btn btn-info" href="https://amenomenu.com/user"><strong>Log in </strong></a></h5>
    </div>
        ...
        <!-- JS Core -->
        <script src="https://amenomenu.com/front/themes/soup/js/core.js"></script>

    </body>
<script>'undefined'=== typeof _trfq || (window._trfq = []);'undefined'=== typeof _trfd && (window._trfd=[]),_trfd.push({'tccl.baseHost':'secureserver.net'},{'ap':'cpbh-mt'},{'server':'p3plmcpnl488027'},{'dcenter':'p3'},{'cp_id':'8044159'},{'cp_cache':''},{'cp_cl':'6'}) // Monitoring performance to make your website faster. If you want to opt-out, please contact web hosting support.</script><script src='https://img1.wsimg.com/traffic-assets/js/tccl.min.js'></script></html>
